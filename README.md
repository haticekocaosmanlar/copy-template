...
function onOpen(e) {
  DocumentApp.getUi()
      ...
      //.addSeparator()                               // Adds seperator if needed.
      .addToUi();
}
...
function insertTemplate(){
  ...
  // Getting current document as target doc.
  ...
  // Find elements in the source doc and insert them to cursor's location of target doc.
